...
| **汉化仓库** | https://github.com/CATMIAOZHI/OpenCodeChineseTranslation |
...
```json
{
  ...
  "maintainer": {
    "name": "CodeCreator",
    "github": "https://github.com/CATMIAOZHI/OpenCodeChineseTranslation"
  },
  "modules": {
...
| [汉化项目 GitHub](https://github.com/CATMIAOZHI/OpenCodeChineseTranslation) | 本项目 |
...
| [问题反馈](https://github.com/CATMIAOZHI/OpenCodeChineseTranslation/issues) | 提交 Issue |
