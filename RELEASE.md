...
1. 从 [Releases](https://github.com/CATMIAOZHI/OpenCodeChineseTranslation/releases) 下载对应平台的压缩包
2. 解压到任意目录
...
| [GitHub 仓库](https://github.com/CATMIAOZHI/OpenCodeChineseTranslation) | GitHub 主页 |
